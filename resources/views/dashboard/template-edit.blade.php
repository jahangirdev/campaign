        ...
        <div class="card-body">
          <form method="POST" action="{{route('template.update', $template->id)}}" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input name="name" class="form-control" id="templateName" value="{{ old('name') ? : $template->name}}">
            </div>
            ...
            <div class="form-group">
              ...
              <img class="img-fluid" src="{{asset($template->screenshot ? : 'backend/uploads/template-placeholder.jpg')}}" alt="" style="max-height:200px;max-width:300px;display:block">
            ...
            <div class="form-group">
              ...
              <select name="status" class="form-control">
                ...
                <option value="publish" {{$template->status == 'publish' ? 'selected': ''}}>Publish</option>
              </select>
            </div>
...
var value = `{!!addslashes($template->code)!!}`;
iblize.setValue(value);
codeField.value = value;
previewTemplate(value);
</script>
@endsection