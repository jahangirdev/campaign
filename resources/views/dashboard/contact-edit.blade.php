          ...
          <form method="POST" action="{{route('contact.update', $contact->id)}}">
            ...
            <div class="row gx-4 mt-3">
              <div class="col">
                ...
                <input name="email" type="email" class="form-control" id="emailAddress" value="{{ old('email') ? : $contact->email}}">
              </div>
              <div class="col">
                <label for="phoneNumber">Phone</label>
                <input name="phone" type="text" class="form-control" id="phoneNumber" value="{{ old('phone') ? : $contact->phone}}">
              </div>
            </div>
            <div class="form-group mt-3">
              ...
              <select class="form-control" name="country" id="country">
                ...
                @foreach($countries as $key => $country)
                  <option value="{{$key}}" {{$contact->country == $key ? 'selected': ''}}>{{$country}}</option>
                @endforeach
              </select>
            </div>
            ...
            <div class="form-group">
              ...
              <input name="address" class="form-control" id="address" value="{{ old('address') ? : $contact->address}}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="list_id" id="country">
                @foreach($lists as $list)
                  <option value="{{$list->id}}" {{$contact->list_id == $list->id ? 'selected' : '' }}>{{$list->name}}</option>
                @endforeach
              </select>
            </div>
